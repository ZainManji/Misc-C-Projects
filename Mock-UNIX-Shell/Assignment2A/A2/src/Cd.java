...
public class Cd extends Command {
	...
	public void execute(String[] param, JShell shell){
		...
		if (param[0].equals("..")){
			...
			shell.setCurDir(shell.getRoot().findDir(path, shell.getRoot()));
		}
		else if (param[0].equals("/")){
			shell.setCurDir(shell.getRoot());
		}
		else if(!(param[0].equals("."))){
			shell.setCurDir(shell.getRoot().findDir(fullPath, shell.getRoot()));
		}
	}
	...
	public boolean checkParameters(String[] param, JShell shell){
		...
		else if (!(param[0].equals(".") || param[0].equals("..") || param[0].equals("/"))){
