...
public class Mv extends Command {
    ...
    public String execute(String[] param, JShell s) {
        ...
        Dir newParentDir = currentDir.searchDir(newPath, rootDir);
        ...
        Dir oldParentDir = currentDir.searchDir(oldPathNoName, rootDir);
        if (oldParentDir.getDocChild(oldName) != null) { // if oldPath refers to
                                                         // a document
     ...
     * directory -the destination path is not a file -the destination is not the
     * source -the path of the moved file/directory is not a currently existing
     * path -the source does not contain the destination
     * 
     * @param param
     *            the parameters passed to Mv: param[0] is the path of the
     *            file/directory to be moved, param[1] is the destination
     ...
     * @return void
     */
    private void correctPaths(Dir currentDir, String parentPath) {
